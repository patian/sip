                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                      ...
                      <select name="category_status" id="" class="form-control">
                          ...
                          <option value="Onhold" <?php echo $category['category_status'] == "Inactive" ? 'selected' : '' ?>>Oh Hold</option>
                          <option value="Deleted" <?php echo $category['category_status'] == "Inactive" ? 'selected' : '' ?>>Deleted</option>
                      </select>
                  </div>
