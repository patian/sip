            ...
            <div class="card-body">
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <?php 
                      echo form_label('Price Base');
                      $product_price_base = [
                        'type'  => 'number',
                        'name'  => 'product_price_base',
                        'id'    => 'product_price_base',
                        'value' => $inputs != null ? $inputs['product_price_base'] : '',
                        'class' => 'form-control',
                        'placeholder' => '0'
                      ];
                      echo form_input($product_price_base); 
                    ?>
                  </div>
                  <div class="form-group">
                    <?php 
                      ...
                      $product_stok = [
                        ...
                        'name'  => 'product_stok',
                        'id'    => 'product_stok',
                        'value' => $inputs != null ? $inputs['product_stok'] : '',
                        'class' => 'form-control',
                        'placeholder' => '0'
                      ];
                      echo form_input($product_stok); 
                    ?>
                  </div>
                </div>
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <?php 
                      echo form_label('Price Sell');
                      $product_price_sell = [
                        'type'  => 'number',
                        'name'  => 'product_price_sell',
                        'id'    => 'product_price_sell',
                        'value' => $inputs != null ? $inputs['product_price_sell'] : '',
                        'class' => 'form-control',
                        'placeholder' => '0'
                      ];
                      echo form_input($product_price_sell); 
                    ?>
                  </div>
                  <div class="form-group">
                    <?php 
...
<?php echo view('components/dash_partials/footer'); ?>